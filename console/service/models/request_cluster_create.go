...
func (m *RequestClusterCreateAuthInfo) Validate(_ strfmt.Registry) error {
	return nil
}

// ContextValidate validates this request cluster create auth info based on context it is used
func (m *RequestClusterCreateAuthInfo) ContextValidate(_ context.Context, _ strfmt.Registry) error {
	return nil
}
