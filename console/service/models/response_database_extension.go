...
func (m *ResponseDatabaseExtension) Validate(_ strfmt.Registry) error {
	return nil
}

// ContextValidate validates this response database extension based on context it is used
func (m *ResponseDatabaseExtension) ContextValidate(_ context.Context, _ strfmt.Registry) error {
	return nil
}
