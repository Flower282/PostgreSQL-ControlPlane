...
func (m *RequestSecretValuePassword) Validate(_ strfmt.Registry) error {
	return nil
}

// ContextValidate validates this request secret value password based on context it is used
func (m *RequestSecretValuePassword) ContextValidate(_ context.Context, _ strfmt.Registry) error {
	return nil
}
